...
import com.rentguruz.app.b2b.carclick.databinding.FragmentNewAgreementBinding;
...
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.RANDUMNUMBERS;
                            ...
                            public void run() {
                                try {
                                    ...
                                    if (status) {
                                        ...
                                        rateModel.ExtraFuelCharge = rateModel.RateFeaturesModel.FuelCharge;
                                        rateModel.ExtraMilesAmount  = rateModel.RateFeaturesModel.ExtraMilesCharges;
                                        rateModel.IsDepositMandatory   = rateModel.RateFeaturesModel.IsDepositManDatory;
                                        rateModel.SecurityDeposit    = rateModel.RateFeaturesModel.SecurityDeposit;
                                        rateModel.GraceMinutes     = rateModel.RateFeaturesModel.GraceMinutes;
                                        rateModel.PayNowDiscount      = rateModel.RateFeaturesModel.PayNowDiscount;
