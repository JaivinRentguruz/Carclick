...
import com.rentguruz.app.b2b.carclick.databinding.FragmentAcceptanceSignatureBinding;
import com.rentguruz.app.b2b.carclick.model.ReservationSignatureModel;
...
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.UPLOADSIGNATURE;
...
public class Fragment_Acceptance_singnature extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            binding.header.screenHeader.setText(getResources().getString(R.string.acceptance_signature));
            binding.header.discard.setText("Clear");

            binding.header.discard.setEnabled(false);
         ...
         /*   if (ActivityCompat.checkSelfPermission(getActivity(), android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            binding.signaturePad.setOnSignedListener(new SignaturePad.OnSignedListener() {
                ...
                public void onSigned() {
                    binding.header.discard.setEnabled(true);
                        ...
                        if (status) {
                            ...
                            NavHostFragment.findNavController(Fragment_Acceptance_singnature.this)
                                   ...
                                   // .navigate(R.id.action_Acceptance_signature_to_Agreements, bundle);
                                    .navigate(R.id.checkoutsuccess, bundle);
