...
public class CustomeDialog {
   ...
   // @ColorInt public static final int  colorAccent  = Color.parseColor(UserData.UiColor.primary);
    ...
    public CustomeDialog(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Log.e("TAG", "CustomeDialog: "+ Color.valueOf(colorAccent) );
            String hexColor = String.format("#%06X", (0xFFFFFF & colorAccent));
            Log.e("TAG", "CustomeDialog: "+ hexColor);
            int dsf = getColorByThemeAttr(context, R.color.colorAccent,Color.parseColor(UserData.UiColor.primary));
            String hexColor2 = String.format("#%06X", (0xFFFFFF & dsf));
            Log.e("TAG", "CustomeDialog: " + hexColor2  );
            int resourceID = context.getResources().getIdentifier("colorAccent", "color", context.getPackageName());
            String hexColor3 = String.format("#%06X", (0xFFFFFF & resourceID));
            Log.e("TAG", "CustomeDialog: " + hexColor3  );

        }
        // themeset();
       /* ResourceBundle bundle = ResourceBundle.getBundle("values.styles", Locale.US);
  ...
  /*  public void getDateFromXML(OnStringListner onStringListner){
    ...
    private void setAttrs(AttributeSet attrs, Context context){
        ...
        //TypedArrayUtils.obtainAttributes(R.style.myDialog,R.style.DialogTheme,)

    }

  /*  @SuppressLint("ResourceType")
    static TypedArray obtainAttributes(AttributeSet attrs, Context context ) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(
                attrs,
                R.theme.DialogTheme,
                0,
        ...
        theme.getResources().getResourceName( 2131099750);
        if (theme == null) {
