...
import com.rentguruz.app.b2b.carclick.databinding.FragmentUpdateCreditcardBinding;
import com.rentguruz.app.b2b.carclick.model.CreditCardModel;
import com.rentguruz.app.b2b.carclick.model.base.UserData;
import com.rentguruz.app.b2b.carclick.model.response.UpdateCard;
...
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.GETBYIDCARD;
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.TableType;
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.UPDATECARD;
   ...
   // public static Context context;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
       ...
       /* Save.setOnClickListener(new View.OnClickListener()
        ...
        char space = ' ';
        binding.edtCardNo.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                ...
                binding.txtCardNumber.setText(s);
                if (s.length()==19){
                    GetCreditCardType(binding.edtCardNo.getText().toString().trim());
                }
            }
        });
    }
