...
import com.rentguruz.app.b2b.carclick.databinding.QmembershipPricingBinding;
...
public class MembershipPrice extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.header.back.setOnClickListener(v -> NavHostFragment.findNavController(MembershipPrice.this).popBackStack());
    }
