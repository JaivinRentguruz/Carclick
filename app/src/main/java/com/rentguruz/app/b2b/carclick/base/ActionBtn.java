package com.rentguruz.app.b2b.carclick.base;
...
public class ActionBtn extends RelativeLayout   implements View.OnClickListener {

 /*   Color btncolor, loadercolor, txtcolor;


    public ActionBtn(@NonNull @NotNull Context context) {
        super(context);
    }

    public ActionBtn(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ActionBtn(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void initview(){
        View view = LayoutInflater.from(getContext()).inflate(R.layout.qcustome_btn, this);
    ...
    String TAG = ActionBtn.class.getSimpleName();
    /**
    ...
    public ActionBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ActionBtn(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
     ...
     * @return
     */
    public ActionBtn setButtonLabel(String string) {
     ...
     * @return
     */
    public ActionBtn setAnimationDuration(int animDuration) {
     ...
     * @return
     */
    public ActionBtn setButtonColor(int buttonColor) {
     ...
     * @param mColor
     */
    public ActionBtn setProgressLoaderColor(int mColor) {
     ...
     * @return
     */
    public ActionBtn setButtonLabelSize(float size) {
     ...
     * @return
     */
    public ActionBtn setButtonLabelColor(int mColor){
     ...
     * @return
     */
    public ActionBtn setProgressErrorIcon(Drawable errorIcon){
     ...
     * @return
     */
    public ActionBtn setProgressDoneIcon(Drawable doneIcon){
     ...
     * @return
     */
    public ActionBtn setNormalAfterError(boolean toNormal){
