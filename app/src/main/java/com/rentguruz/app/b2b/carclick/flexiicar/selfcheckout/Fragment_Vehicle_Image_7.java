...
public class Fragment_Vehicle_Image_7 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        lblNext=view.findViewById(R.id.lblNext7);
        UploadImg=view.findViewById(R.id.Image_Upload7);
        imgback=view.findViewById(R.id.backimg7);
        ...
        try {
            ...
            txtDiscard=view.findViewById(R.id.DiscardVeh7);
            ...
            txtDiscard.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                            .navigate(R.id.action_Vehicle_Image_7_to_Agreements);
                }
            });
        }
        catch (Exception e){
