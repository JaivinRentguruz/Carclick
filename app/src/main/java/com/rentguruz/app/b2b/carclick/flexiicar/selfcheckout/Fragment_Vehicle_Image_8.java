...
public class Fragment_Vehicle_Image_8 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        lblNext=view.findViewById(R.id.lblNext8);
        UploadImg=view.findViewById(R.id.Image_Upload8);
        imgback=view.findViewById(R.id.backimg8);
        ...
        try {
            ...
            txtDiscard=view.findViewById(R.id.DiscardVeh8);
            ...
            txtDiscard.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                            .navigate(R.id.action_Vehicle_Image_8_to_Agreements);
                }
            });
        }
        catch (Exception e){
