...
public class Helper {
   ...
   // public static InsuranceModel insuranceModel = new InsuranceModel();
    ...
    public static Boolean selectCardforpmt = false;
    public static int checkinod = 0;
    ...
    public static String getDateDisplay ( String date){
        String s = null;
        Date date1 = null;
        SimpleDateFormat datewithtime = new SimpleDateFormat(DateType.fulldate.anInt, Locale.getDefault());
        SimpleDateFormat returndate =  new SimpleDateFormat(displayDate, Locale.getDefault());
        try {
            date1= datewithtime.parse(date);
            s = returndate.format(date1);
