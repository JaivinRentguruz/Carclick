...
import com.rentguruz.app.b2b.carclick.databinding.QmembershipPricingDetailsBinding;
...
public class MembershipPriceDetail extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.header.back.setOnClickListener(v -> NavHostFragment.findNavController(MembershipPriceDetail.this).popBackStack());
    }
