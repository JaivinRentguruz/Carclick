...
import com.rentguruz.app.b2b.carclick.model.parameter.enums.ReservationMainType;
...
import com.rentguruz.app.b2b.carclick.model.reservation.ReservationBusinessSource;
...
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.BusinessSourceMasterALL;
        ...
        for (int i = 0; i <locationListsData.length; i++) {
            ...
            if (locationListsData.length > 1) {
                ...
                if (UserData.loginResponse.User.addressesModel != null) {
                    if (UserData.loginResponse.User.LocationId == location.Id) {
                        binding.pickuploc.setLocation(location);
                        binding.droploc.setLocation(returnlocation);
                        break;
                    }
