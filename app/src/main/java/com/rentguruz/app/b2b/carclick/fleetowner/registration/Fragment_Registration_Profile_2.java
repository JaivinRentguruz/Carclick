...
public class Fragment_Registration_Profile_2 extends Fragment
{
    ...
    EditText edt_DriverLicenseNO;
    Spinner DL_IssueBy,StateandProvience;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            DL_IssueBy = view.findViewById(R.id.Sp_Country);
            StateandProvience = view.findViewById(R.id.Sp_State);
