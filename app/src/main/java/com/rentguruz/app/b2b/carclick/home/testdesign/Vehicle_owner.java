...
import com.rentguruz.app.b2b.carclick.databinding.QvehicleSliderBinding;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.header.discard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(Vehicle_owner.this).navigate(R.id.vehicleOwner_select);
            }
        });
