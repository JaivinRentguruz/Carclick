    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
          ...
          //  AgreementsBundle = getArguments().getBundle("AgreementsBundle");
            ...
            QrImages = view.findViewById(R.id.QR_Image);
            ...
            txtconforNo=view.findViewById(R.id.txt_conformationNo);
      ...
      /*      String VehicleImgstr=AgreementsBundle.getString("veh_Img_Path");
            ...
            txtCheckInLocName.setText(reservations.PickUpLocationName);
            txtcheckOutLocName.setText(reservations.DropLocationName);
     ...
     /*       String check_IN=(AgreementsBundle.getString("check_IN"));
            ...
            txtCheckInDate.setText(reservations.CheckInDate);
...
//            txtVehicleType.setText(AgreementsBundle.getString("vehicle_Type_Name"));
            //txtVehicleName.setText(reservations.VehicleId);

            //reservation_ID=reservations.ReservationNo;
            txtconforNo.setText(reservations.ReservationNo);
            ...
            BackArrow.setOnClickListener(new View.OnClickListener()
            {
               ...
               /*         ImageList = new JSONArray(getArguments().getString("ImageList"));
                        ...
                        NavHostFragment.findNavController(Fragment_Summary_Of_Charges_For_SelfCheckIn.this)
                                .navigate(R.id.action_SummaryOfChargeForSelfCheckIn_to_Self_check_In);
                    }catch (Exception e)
                    {
                        e.printStackTrace();
                    }
            ...
            term_conditionArrow.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                  /*  Bundle Agreements = new Bundle();
                    ...
                    NavHostFragment.findNavController(Fragment_Summary_Of_Charges_For_SelfCheckIn.this)
                            .navigate(R.id.action_SummaryOfChargeForSelfCheckIn_to_TermAndCondition);
                }
            });
            ...
            /*        Bundle SelfCheckInBundle = new Bundle();
                    ...
                    System.out.println(SelfCheckInBundle);*/
                    NavHostFragment.findNavController(Fragment_Summary_Of_Charges_For_SelfCheckIn.this)
                            .navigate(R.id.action_SummaryOfChargeForSelfCheckIn_to_PaymentCheckOutSelfCheckIn,bundle);
                }
            });
            ...
            driverPhone.setText(reservations.MobileNo);
            driverEmail.setText(reservations.Email);
