package com.rentguruz.app.b2b.carclick.home.more;
...
import com.rentguruz.app.b2b.carclick.databinding.FragmentMoreDetailsBinding;
...
public class Fragment_More extends BaseFragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            binding.name.setText(UserData.loginResponse.User.FirtName + " " + UserData.loginResponse.User.FirtName);
            binding.mobile.setText(UserData.loginResponse.User.Telephone);
        } catch (Exception e){
            e.printStackTrace();
        }
