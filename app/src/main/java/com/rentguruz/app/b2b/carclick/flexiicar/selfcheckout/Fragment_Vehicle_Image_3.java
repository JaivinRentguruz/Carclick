...
public class Fragment_Vehicle_Image_3 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        lblNext=view.findViewById(R.id.backlbl_driverside);
        UploadImg=view.findViewById(R.id.DriverSideImage);
        imgback=view.findViewById(R.id.backimg_driverside);
        ...
        try
        {
            ...
            txtDiscard=view.findViewById(R.id.DiscardVeh3);
            ...
            txtDiscard.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_3.this)
                            .navigate(R.id.action_Vehicle_Image_3_to_Agreements);
                }
            });
        }
        catch (Exception e){
