...
import com.rentguruz.app.b2b.carclick.databinding.FragmentVehicleCurrentRentalBinding;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.optionmenu:
                ...
                TransitionManager.beginDelayedTransition(binding.sucessfullRegi,transition);
                binding.sucessfullRegi.setVisibility(View.VISIBLE);
                break;
            ...
            case R.id.cancel:
                ...
                TransitionManager.beginDelayedTransition(binding.sucessfullRegi,transition2);
