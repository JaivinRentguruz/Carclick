...
import com.rentguruz.app.b2b.carclick.adapters.CustomDrawable;
import com.rentguruz.app.b2b.carclick.adapters.CustomeView;
import com.rentguruz.app.b2b.carclick.adapters.Helper;
import com.rentguruz.app.b2b.carclick.databinding.CustomProgresssBinding;
...
abstract public class BaseFragment extends Fragment implements View.OnClickListener {
    ...
    /*    try {
       ...
       /* if(Helper.currencySymbol == null || Helper.currencySymbol.length() == 0){
        ...
        int resourceID = context.getResources().getIdentifier("colorAccent", "color", context.getPackageName());

        loginRes.storedata("android:colorAccent", String.valueOf(Color.parseColor(UiColor.secondary)));
