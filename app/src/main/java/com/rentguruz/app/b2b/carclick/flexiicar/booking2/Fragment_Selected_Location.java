...
import com.rentguruz.app.b2b.carclick.model.response.CompanyLabel;
...
import com.rentguruz.app.b2b.carclick.databinding.FragmentSelectedLocationBinding;
import com.rentguruz.app.b2b.carclick.flexiicar.login.Login;
import com.rentguruz.app.b2b.carclick.model.BusinessSource;
...
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.AVAILABLELOCATION;
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.BASE_URL_LOGIN;
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.BUSINESSBOOKINGTYPE;
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.BusinessSourceMaster;
  ...
  //  RelativeLayout calanderlayout, time_relative_layout, relative_layout_droptime;
   ...
   // private static final String TAG = Fragment_Selected_Location.class.getSimpleName();
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            if (UserData.loginResponse.CompanyLabel !=null){
                ...
                UserData.loginResponse.CompanyLabel = new CompanyLabel();
            }
            binding.setLabel(UserData.loginResponse.CompanyLabel );
        } catch (Exception e){
            e.printStackTrace();
        }
                        ...
                        try {
                            ...
                            for (int i = 0; i < businessSourceList.length; i++) {
                                if (businessSourceList[i].IsDefault) {
                                    ...
                                    new ApiService(locationData, RequestType.POST, BusinessSourceMaster, BASE_URL_LOGIN, header, params.getBusinessSource(Customer_Booking_Activity.businessSource.Id));
    ...
    /*    try {
            ...
            dropDownList = (new DropDown(BUSINESSBOOKINGTYPE,1,true,true));
        ...
        {     LinearLayout lblselectedlocation = view.findViewById(R.id.lblcontinue1);
            try {
                binding.businessSource.setVisibility(View.GONE);
                binding.businessSourceLine.setVisibility(View.GONE);
            ...
            try {
                if (Helper.SelectDateDisplay){
                  //  binding.lblchangeLocation.setVisibility(View.GONE);
                   // binding.pickupline.setVisibility(View.GONE);
                   // binding.returnDisplay.setVisibility(View.GONE);
                    binding.differentLocationLayout.setVisibility(View.GONE);
...
//                    getDropdownId(binding.businessMaster.getSelectedItem().toString());
                    businessmaster = Customer_Booking_Activity.businessSource.Id;
                    if (returnlocation!= null)
...
//                businessmaster = idd;
                ...
                try
                {
                    ...
                    if (status)
                    {
                     ...
                     //   rlLocationlist.removeAllViews();
                        ...
                        for (int j = 0; j < len; j++)
                        {
                            location = locationLists[j];
                            returnlocation = locationLists[j];
                         /*   binding.txtLocationName.setText(location.Name);
                            binding.txtStreetLoc.setText(Html.fromHtml(location.AddressesModel.PreviewAddress));
                            binding.returnLocationName.setText(returnlocation.Name);
                            binding.txtReturnStreet.setText(Html.fromHtml(returnlocation.AddressesModel.PreviewAddress));*/
    ...
    OnResponseListener locationData = new OnResponseListener() {
        @Override
        public void onSuccess(String response, HashMap<String, String> headers) {
            handler.post(() -> {
                try {
