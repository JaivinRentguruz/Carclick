...
import com.rentguruz.app.b2b.carclick.databinding.FragmentHomeBinding;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
      ...
      //  getview.getCompanyLabel(view, companyLabel);
        ...
        try {
            ...
            name.setText(UserData.loginResponse.User.FirtName + " " + UserData.loginResponse.User.LastName);
            try {
             ...
             //  String datas =  UserData.loginResponse.User.UserName.split(" ")[1];
                setText(binding.details.l, UserData.loginResponse.User.LastName);
                setText(binding.details.f, UserData.loginResponse.User.FirtName);
            } catch (Exception e){
                e.printStackTrace();
       ...
       binding.lblUserTimeLine.setOnClickListener(v -> {
           NavHostFragment.findNavController(Fragment_Home_Tab.this).navigate(R.id.membership1);
       });

        binding.lblAgreement.setOnClickListener(v -> NavHostFragment.findNavController(Fragment_Home_Tab.this).navigate(R.id.vehicleOwner2));
    }
