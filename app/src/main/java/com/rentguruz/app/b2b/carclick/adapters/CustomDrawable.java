...
public class CustomDrawable {
    ...
    public GradientDrawable getsquareline()  {
        Drawable drawable = context.getResources().getDrawable(R.drawable.curve_single_text22);
    ...
    public GradientDrawable getsquareline(int user)  {
        Drawable drawable = context.getResources().getDrawable(R.drawable.curve_text_line);
        GradientDrawable drawable1 = (GradientDrawable) drawable;
        drawable1.mutate();
        drawable1.setStroke(user,Color.parseColor(Uicolor.primary));
        return drawable1;
    }
