...
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.BASE_URL_PAYMENT;
import static com.rentguruz.app.b2b.carclick.apicall.ApiEndPoint.PAYMENTPROCESS;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        try {
           ...
           // txt_vehicletype = view.findViewById(R.id.textV_VehicleTypeVName);
            ...
            txt_vehName.setText(reservations.VehicleName);
          //  txt_vehicletype.setText(AgreementsBundle.getString("vehicle_Type_Name"));

            txt_ReturnLocName.setText(reservations.DropLocationName);
            txt_PickLocName.setText(reservations.PickUpLocationName);

            int check_IN=(reservations.ReservationStatus);
            // Date
            ...
            txt_ReturnDate.setText(reservations.CheckInDate);
            ...
            txt_PickupDate.setText(reservations.CheckOutDate);
               ...
               /* String creditCardJSONStr = getArguments().getString("creditcard");
                ...
                lblprocess.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View view)
                    {
                        ...
                        NavHostFragment.findNavController(Fragment_Payment_CheckOut_For_User_SelfCheckIn.this)
                                .navigate(R.id.action_PaymentCheckOutSelfCheckIn_to_Payment_Success,bundle);
