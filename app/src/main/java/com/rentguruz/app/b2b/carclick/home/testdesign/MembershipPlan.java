...
import com.rentguruz.app.b2b.carclick.databinding.QmembershipBinding;
...
public class MembershipPlan  extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.header.back.setOnClickListener(v -> NavHostFragment.findNavController(MembershipPlan.this).popBackStack());
    }
