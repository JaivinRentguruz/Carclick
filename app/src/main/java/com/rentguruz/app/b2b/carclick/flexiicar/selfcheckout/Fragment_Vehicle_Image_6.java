...
public class Fragment_Vehicle_Image_6 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        lblNext=view.findViewById(R.id.lblNext6);
        UploadImg=view.findViewById(R.id.Image_Upload6);
        imgback=view.findViewById(R.id.backimg6);
        ...
        try {
            ...
            txtDiscard=view.findViewById(R.id.DiscardVeh6);
            ...
            txtDiscard.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_6.this)
                            .navigate(R.id.action_Vehicle_Image_6_to_Agreements);
                }
            });
        }
        catch (Exception e){
